...
SELECT f.name AS facility_name, CONCAT(m.firstname, ' ', m.surname) AS member_fullname
...
WHERE starttime >= '2012-09-14' AND starttime < '2012-09-15'AND CASE WHEN firstname = 'GUEST' THEN 

guestcost * slots ELSE membercost * slots END > 30
ORDER BY cost DESC;	
...
WHERE starttime >= '2012-09-14' AND starttime < '2012-09-15'AND cost > 30
ORDER BY cost DESC;
...
>>>>>>> 0714866abfa00e5e607c8a79663dd93a5c38bf55
ORDER BY revenue;